...
void MainFrame::startEngine() {
    ...
    if (!m_engineThread) {
        ...
        m_engineThread->set_show_owner(m_panelBoard->getShowOwner());
        m_engineThread->set_show_probabilities(m_panelBoard->getShowProbabilities());
#endif
